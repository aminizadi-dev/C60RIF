...
public partial class AdminMapperConfiguration : Profile, IOrderedMapperProfile
{
    ...
    protected virtual void CreateCustomersMaps()
    {
        ...
        CreateMap<DisciplinaryForm, DisciplinaryFormModel>()
            ...
            .ForMember(model => model.ReferralReasonRetravelConsumptionLessThanOneCcOt, options => options.Ignore())
            .ForMember(model => model.ReferralReasonWritingCd, options => options.Ignore())
            .ForMember(model => model.ReferralReasonOther, options => options.Ignore())
            .ForMember(model => model.EducationalResourceJahanbiniBooklet, options => options.Ignore())
            .ForMember(model => model.EducationalResourceSixtyDegreeBook, options => options.Ignore())
            .ForMember(model => model.EducationalResourceEshghBook, options => options.Ignore())
            .ForMember(model => model.EducationalResourceTwelveArticles, options => options.Ignore())
            .ForMember(model => model.ServiceRolePublications, options => options.Ignore())
            .ForMember(model => model.ServiceRoleOt, options => options.Ignore())
            .ForMember(model => model.ServiceRoleSite, options => options.Ignore())
            .ForMember(model => model.ServiceRoleGuard, options => options.Ignore())
            .ForMember(model => model.ServiceRoleSecretary, options => options.Ignore())
            .ForMember(model => model.ServiceRoleGuide, options => options.Ignore())
            .ForMember(model => model.ServiceRoleNewcomer, options => options.Ignore())
            .ForMember(model => model.ServiceRoleMarzban, options => options.Ignore())
            .ForMember(model => model.FamilyRelapseFactorCigaretteUse, options => options.Ignore())
            .ForMember(model => model.FamilyRelapseFactorSickness, options => options.Ignore())
            .ForMember(model => model.FamilyRelapseFactorFinancialAndMaritalIssues, options => options.Ignore())
            .ForMember(model => model.FamilyRelapseFactorFamilyIssues, options => options.Ignore())
            .ForMember(model => model.FamilyRelapseFactorEconomicIssues, options => options.Ignore())
            .ForMember(model => model.FamilyRelapseFactorOverweight, options => options.Ignore())
            .ForMember(model => model.FamilyRelapseFactorOther, options => options.Ignore())
            .ForMember(model => model.AbsenceDuration, options => options.MapFrom(src => (int)src.AbsenceDuration))
            .ForMember(model => model.RelapseDuration, options => options.MapFrom(src => (int)src.RelapseDuration))
            .ForMember(model => model.CigaretteTreatmentStatus, options => options.MapFrom(src => (int)src.CigaretteTreatmentStatus))
            .ForMember(model => model.EducationLevel, options => options.MapFrom(src => src.EducationLevel.HasValue ? (int?)src.EducationLevel.Value : null));
        ...
        CreateMap<DisciplinaryFormModel, DisciplinaryForm>()
            ...
            .ForMember(entity => entity.FamilyRelapseFactors, options => options.Ignore())
            .ForMember(entity => entity.AbsenceDuration, options => options.MapFrom(src => (DisciplinaryReferralAbsenceDuration)src.AbsenceDuration))
            .ForMember(entity => entity.RelapseDuration, options => options.MapFrom(src => (DisciplinaryReferralRelapseDuration)src.RelapseDuration))
            .ForMember(entity => entity.CigaretteTreatmentStatus, options => options.MapFrom(src => (CigaretteTreatmentStatus)src.CigaretteTreatmentStatus))
            .ForMember(entity => entity.EducationLevel, options => options.MapFrom(src => src.EducationLevel.HasValue ? (EducationLevel?)src.EducationLevel.Value : null));
    }
    ...
    protected virtual void CreateDirectoryMaps()
    {
        ...
        CreateMap<City, CityModel>()
            ...
            .ForMember(model => model.NumberOfClinics, options => options.Ignore())
            .ForMember(model => model.AgencySearchModel, options => options.Ignore())
            .ForMember(model => model.ClinicSearchModel, options => options.Ignore());
